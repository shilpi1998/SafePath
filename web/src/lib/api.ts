...
export const upvoteIncident = (id: number) =>
  api.post(`/api/safety/incidents/${id}/upvote`);
...
export const getHeatmap = (lat: number, lng: number, radius_km = 50) =>
